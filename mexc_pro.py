...
def dip_radar(m):
    ...
    valid = score >= 15 and m["dist_low"] <= 10 and m["vol_ratio"] >= 1.8 and m["usdt_vol"] >= 60000 and m["bounce"] >= 1.2 and m["obv_turn"] and m["coin_change_15m"] >= 0.5 and m["relative_strength"] >= 0.8 and m["money_impact"] >= 2.0
